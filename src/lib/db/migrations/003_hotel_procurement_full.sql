...
-- Новые позиции, которых не было в 002
...
CROSS JOIN (VALUES
  ...
  ('Спальня', 'Направляющая для изголовья', 40, 0, 0, 'Латунные трубки, можно карнизы', NULL, 535),
  ('Электрика', 'Розетки и выключатели', 0, 0, 0, 'На пробу; см. ссылку', 'https://detail.1688.com/offer/1021381992785.html', 780),
